...
const humanExpressions = [
    ...
    { img: './img/home.jpg', text: 'Quero ir lá fora' },
    { img: './img/hurt.jpg', text: 'Estou machucado' },
    { img: './img/outside.jpg', text: 'Quero ir pra casa' },
...
main.addEventListener("click", (event) => {
	...
	const clickdElementTextMustBeSpoken = ["img", "p"].some(
		(elementName) =>
			clickedElement.tagName.toLowerCase() === elementName.toLowerCase()
	);

	if (clickdElementTextMustBeSpoken) {
...
const setPTBRVoices = (voices) => {
	...
	const microsoftVoice = voices.find(
		(voice) => voice.name === "Microft Maria Desktop - Portuguese(Brasil)"
	);
